...
export class Migration1764077161969 implements MigrationInterface {
    name = 'Migration1764077161969'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."verification_review_type_enum" AS ENUM('mentor', 'community')`);
